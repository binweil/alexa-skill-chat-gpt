export const languageStringsEnglish = {
  translation: {
    ...
    LAUNCH_MESSAGE: "Welcome to Chat G P T.<break time=\'0.3s\'/>. I can chat on any topic or generate image for you. How can I help you today?",
    HELP_MESSAGE: "This skill is powered by ChatGPT 3.5. Here's what I can do: " +
        "1. Chat on any topic. <break time=\'0.3s\'/> You can ask <break time=\'0.3s\'/> Why sky is blue <break time=\'0.5s\'/>" +
        "2. Generate image. <break time=\'0.3s\'/> Start your question with <break time=\'0.3s\'/> Show image for <break time=\'0.3s\'/>. You can say <break time=\'0.3s\'/> Show Image for deep sea animal  <break time=\'0.5s\'/>" +
        "3. Clear context. <break time=\'0.3s\'/> Just say <break time=\'0.3s\'/> clear <break time=\'0.5s\'/>",
    HELP_REPROMPT: "Try asking me <break time='0.5s'/> Why sky is blue ",
    QUESTION_RESPONSE: '%s',
    ...
    OPENAI_ERROR_MESSAGE: "Sorry, the answer cannot be rendered on Alexa.",
    DEVICE_CAPABILITY_ERROR_MESSAGE: "Sorry, your device does not support rendering image",
    EXIT_MESSAGE: 'Talk to you later!',
    FALLBACK_MESSAGE: "Sorry, I didn't get your questions. Please say <break time=\'0.3s\'/> help <break time=\'0.3s\'/> to see what I can do.",
